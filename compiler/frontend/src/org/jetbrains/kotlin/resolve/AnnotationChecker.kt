...
class AnnotationChecker(
    ...
    companion object {
        ...
        fun loadAnnotationTargets(targetEntryDescriptor: AnnotationDescriptor): Set<KotlinTarget>? {
            // TODO (!):
            // val valueArgument = targetEntryDescriptor.allValueArguments[TARGET_ALLOWED_TARGETS]?.value as? ArrayValue ?: return null

            val valueArgument = targetEntryDescriptor.allValueArguments.entries.firstOrNull()?.value as? ArrayValue ?: return null
